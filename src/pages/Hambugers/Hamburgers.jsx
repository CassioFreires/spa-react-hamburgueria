...
const Hamburguers = () => {
  ...
  const [isAdded, setIsAdded] = useState(null); // Estado para mostrar que o item foi adicionado ao carrinho
  const { user } = useUser(); // Acessa o usuário autenticado do contexto
  const navigate = useNavigate();

  // Função para carregar os hambúrgueres da API
  useEffect(() => {
