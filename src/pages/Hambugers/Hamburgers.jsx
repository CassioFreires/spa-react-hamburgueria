...
const Hamburguers = () => {
    ...
    const allItemsLocalHistorage = [...cartLocalStorage, ...cartPromotionLocalStorage, ...cartComboBurgerLocalHistorage, ...cartDrinksLocalHistorage]; // expalhando todos os itens do localhistorage
